...
SOURCEFILES_QUOTED_IF_SPACED=BLDC_Esc/BLDC_Esc.c BLDC_Esc/Timer_Events.c USB_Config/usb_descriptors.c USB_Config/usb_app.c USB_Framework/usb_device.c USB_Framework/usb_device_hid.c main.c system.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/BLDC_Esc/BLDC_Esc.p1 ${OBJECTDIR}/BLDC_Esc/Timer_Events.p1 ${OBJECTDIR}/USB_Config/usb_descriptors.p1 ${OBJECTDIR}/USB_Config/usb_app.p1 ${OBJECTDIR}/USB_Framework/usb_device.p1 ${OBJECTDIR}/USB_Framework/usb_device_hid.p1 ${OBJECTDIR}/main.p1 ${OBJECTDIR}/system.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/BLDC_Esc/BLDC_Esc.p1.d ${OBJECTDIR}/BLDC_Esc/Timer_Events.p1.d ${OBJECTDIR}/USB_Config/usb_descriptors.p1.d ${OBJECTDIR}/USB_Config/usb_app.p1.d ${OBJECTDIR}/USB_Framework/usb_device.p1.d ${OBJECTDIR}/USB_Framework/usb_device_hid.p1.d ${OBJECTDIR}/main.p1.d ${OBJECTDIR}/system.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/BLDC_Esc/BLDC_Esc.p1 ${OBJECTDIR}/BLDC_Esc/Timer_Events.p1 ${OBJECTDIR}/USB_Config/usb_descriptors.p1 ${OBJECTDIR}/USB_Config/usb_app.p1 ${OBJECTDIR}/USB_Framework/usb_device.p1 ${OBJECTDIR}/USB_Framework/usb_device_hid.p1 ${OBJECTDIR}/main.p1 ${OBJECTDIR}/system.p1

# Source Files
SOURCEFILES=BLDC_Esc/BLDC_Esc.c BLDC_Esc/Timer_Events.c USB_Config/usb_descriptors.c USB_Config/usb_app.c USB_Framework/usb_device.c USB_Framework/usb_device_hid.c main.c system.c
...
dist/${CND_CONF}/${IMAGE_TYPE}/Firmware.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	...
	${MP_CC} $(MP_EXTRA_LD_PRE) --chip=$(MP_PROCESSOR_OPTION) -G -mdist/${CND_CONF}/${IMAGE_TYPE}/Firmware.${IMAGE_TYPE}.map  -D__DEBUG=1 --debugger=pickit3  --double=24 --float=24 --emi=wordwrite --opt=default,+asm,+asmfile,-speed,+space,-debug --addrqual=ignore --mode=free -P -N255 -I"USB_Framework" -I"./" -I"USB_Config" -I"BLDC_Esc" --warn=-3 --asmlist -DXPRJ_default=$(CND_CONF)  --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-download,+config,+clib,-plib --output=-mcof,+elf:multilocs --stack=compiled:auto:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"     --rom=default,-7dc0-7fff --ram=default,-3f4-3ff,-f9c-f9c,-fd4-fd4,-fdb-fdf,-fe3-fe7,-feb-fef,-ffd-fff  $(COMPARISON_BUILD) --memorysummary dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -odist/${CND_CONF}/${IMAGE_TYPE}/Firmware.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
	@${RM} dist/${CND_CONF}/${IMAGE_TYPE}/Firmware.${IMAGE_TYPE}.hex 
	
else
dist/${CND_CONF}/${IMAGE_TYPE}/Firmware.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) --chip=$(MP_PROCESSOR_OPTION) -G -mdist/${CND_CONF}/${IMAGE_TYPE}/Firmware.${IMAGE_TYPE}.map  --double=24 --float=24 --emi=wordwrite --opt=default,+asm,+asmfile,-speed,+space,-debug --addrqual=ignore --mode=free -P -N255 -I"USB_Framework" -I"./" -I"USB_Config" -I"BLDC_Esc" --warn=-3 --asmlist -DXPRJ_default=$(CND_CONF)  --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-download,+config,+clib,-plib --output=-mcof,+elf:multilocs --stack=compiled:auto:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"     $(COMPARISON_BUILD) --memorysummary dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -odist/${CND_CONF}/${IMAGE_TYPE}/Firmware.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
